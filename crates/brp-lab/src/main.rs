...
//!
//! Usage: `cargo run -p brp-lab --release -- samples/`

use anyhow::{bail, Context, Result};
use brp_lab::{all_codecs, Codec};
...
fn measure(codec: &dyn Codec, img: &brp_core::RawImage) -> Result<Measurement> {
...
fn dimensions(img: &brp_core::RawImage) -> String {
