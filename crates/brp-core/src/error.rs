...
pub enum BrpError {
    ...
    #[error("unsupported bit depth {0}, only 8 is defined in version 6")]
    ...
    #[error("unsupported filter mode {0}, version 6 defines 0, 1 and 2")]
    UnsupportedFilterMode(u8),

    #[error("unsupported block coder {0}, version 6 defines 0, 1 and 2")]
